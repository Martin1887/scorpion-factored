...
BitsetIterator CartesianSet::begin_values(int var) const {
    return BitsetIterator(domain_subsets[var], 0);
}

BitsetIterator CartesianSet::end_values(int var) const {
    return BitsetIterator(domain_subsets[var], domain_subsets[var].size());
}
